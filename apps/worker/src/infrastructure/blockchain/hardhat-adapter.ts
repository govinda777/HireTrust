...
import EscrowEngineArtifact from '../../../../packages/blockchain/artifacts/contracts/EscrowEngine.sol/EscrowEngine.json';
...
export class HardhatAdapter {
  ...
  constructor() {
    ...
    this.escrowContract = new ethers.Contract(contractAddress, EscrowEngineArtifact.abi, this.wallet);
  }
